...
ADMINS = ['"Dan Tran" <tranvandanmail3@gmail.com>']
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://localhost:4000",
    "http://127.0.0.1:4000",
    env("CORS_ALLOWED_ORIGIN", default="http://localhost:3000"),
]
...
# dj_rest_auth - https://dj-rest-auth.readthedocs.io/en/latest/configuration/settings/
